...
## AWS Billing Alerts
AWS Billing Alerts is a way of monitoring your estimated charges for your AWS account. You can do this by enabling ``Billing Alarms`` in your Root User account or an IAM user account that has permission to viewing billing information. This alarm only gets triggered when your account billing exceeds your threshold. A threshold is a specified percentage of your billing cost set to alert when exceeded. US East (N. Virginia) Region represents AWS global charges.
